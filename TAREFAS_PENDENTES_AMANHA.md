...
### 🟢 1. Subdomínio Público no Cloudflare R2 Ativado & Validado
...
### 🟢 2. Correção de Sensibilidade ao Toque Mobile & Git Push (v1.1.0)
...
### 🟢 3. Deep Research Completa de Mini-Jogos Bíblicos & Gamificação
...
### 🟢 4. Novas Telas: Web Rádio 24h & Hinário Digital (Coletânea de Louvores)
...
### 🟢 5. Mega-Patrimônio Teológico & Espiritual Integrado
...
### 🟢 6. Banco de Dados Duplo: Nuvem (Supabase) + Offline-First (SQLite Local)
...
### 🟢 7. Upload dos 576 Cortes para Cloudflare R2
...
|---|---|---|---|---|
| **1** | 🔴 **ALTA** | [**Instalar Nova Atualização do APK (v1.1.0) no Celular**](#-tarefa-1-instalar-nova-atualização-do-apk-v110-no-celular) | Mobile / QA | 3 min |
| **2** | 🟡 **MÉDIA** | [**📸 Obter e Sincronizar Link do Drive de Fotos dos Cultos**](#-tarefa-2-obter-e-sincronizar-link-do-drive-de-fotos-dos-cultos) | Mídia / Fotos | 10 min |
| **3** | 🟡 **MÉDIA** | [**🎮 Implementar Módulo de Mini-Jogos Bíblicos**](#-tarefa-3-implementar-módulo-de-mini-jogos-bíblicos) | Telas / Jogos | 1 dia |
...
| **5** | 🟢 **BAIXA** | [**Configurar Streaming Oficial da Web Rádio (Zeno.fm - Opcional)**](#-tarefa-5-configurar-streaming-oficial-da-web-rádio-zenofm) | Áudio / Rádio | 10 min |
...
### 🔴 Tarefa 1: Instalar Nova Atualização do APK (v1.1.0) no Celular
* **Objetivo:** Instalar o novo `.apk` compilado com as correções de toque nos botões, Web Rádio 24h, Hinário e vídeos do Cloudflare R2 ativos.
* **Instruções de Download:**
  1. Acesse pelo celular ou PC a página da nova compilação:  
     👉 [Acompanhar / Baixar no GitHub Actions](https://github.com/matheusbarbosatech/ibpmcr-app/actions)
  2. Role até a seção **Artifacts** e clique em **`IBPM_CR_SuperApp_Release_APK`** para baixar o `.zip`.
  3. Extraia e instale o arquivo `app-release.apk` no seu celular Android.
* **Validação no Celular:**
  - [ ] Testar toque nos atalhos da Home (*Oração*, *Estudos*, *Dízimos*, *Como Chegar*).
  - [ ] Testar troca de sub-abas em *Palavra & Estudos* (Devocional, Bíblia, Livros, Hinário).
  - [ ] Testar reprodução de vídeo de cortes em *Fotos & Mídia*.

---

### 🟡 Tarefa 2: Obter e Sincronizar Link do Drive de Fotos dos Cultos
...
### 🟡 Tarefa 3: Implementar Módulo de Mini-Jogos Bíblicos
...
### 🟢 Tarefa 5: Configurar Streaming Oficial da Web Rádio (Zeno.fm)
